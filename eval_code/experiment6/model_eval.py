...
if __name__ == "__main__":
    ...
    #eval('save_root', batch_size=10, use_cuda=False, only_first_N=20)

    eval_inception = True

    if eval_inception:
        paths = ['save_root/data_real/', 'save_root/data_fake/']
        fid_values = fid.calculate_fid_given_paths(paths, 10, 'cpu',2048)
        print(fid_values)
